...
namespace OptionPricer
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var europeanOption = new EuropeanOption(user_ticker, op_strike, user_op_type, days);
            ...
            if (user_ticker == "RWX")
            {
                //double theo_price = europeanOption.optionPrice(_share_price = 100, rf = 0.05, implied_vol = 0.2, div_yield = 0);

                Console.WriteLine("Enter the market option price:");
                double mkt_option_price = double.Parse(Console.ReadLine());

                var impliedVol = new ImpliedVol(mkt_option_price, op_strike, days, _share_price = 100, rf = 0.05, Math.Pow(10, -5), div_yield = 0);

                double imp_vol = impliedVol.newton_vol(user_op_type);

                ///This is the test case.....
                Console.WriteLine($"The option price of your {user_op_type} option is {europeanOption.optionPrice(_share_price = 100, rf = 0.05, implied_vol = 0.2, div_yield = 0)}");
                Console.WriteLine($"The option delta is {europeanOption.sensitivity(_share_price = 100, rf = 0.05, div_yield = 0, implied_vol = 0.2, "delta")}");
                Console.WriteLine($"The option gamma is {europeanOption.sensitivity(_share_price = 100, rf = 0.05, div_yield = 0, implied_vol = 0.2, "gamma")}");
                Console.WriteLine($"The option vega is {europeanOption.sensitivity(_share_price = 100, rf = 0.05, div_yield = 0, implied_vol = 0.2, "vega")}");
                Console.WriteLine($"The implied volatility is {imp_vol}");
            } 
            else
            {
                //Get the share price corresponding to the _Ticker_ entered by the user and the time to maturity of the option.//
                List<MarketData> marketDatas = await LoadExcelFile(path, user_ticker.ToUpper(), user_start_date, days);
                ...
                foreach (MarketData marketData in marketDatas)
                {
                    ...
                    Console.WriteLine($"The volatility is {marketData.volatility}");
                    Console.WriteLine($"The dividend yield is {marketData.dividend}");
                }

                //double theo_price = europeanOption.optionPrice(_share_price, rf, implied_vol, div_yield);

                Console.WriteLine("Enter the market option price:");
                double mkt_option_price = double.Parse(Console.ReadLine());

                var impliedVol = new ImpliedVol(mkt_option_price, op_strike, days, _share_price, rf, Math.Pow(10, -5), div_yield);

                double imp_vol = impliedVol.newton_vol(user_op_type);

                Console.WriteLine($"The option price of your {user_op_type} option is {europeanOption.optionPrice(_share_price, rf, implied_vol, div_yield)}");
                Console.WriteLine($"The option delta is {europeanOption.sensitivity(_share_price, rf, div_yield, implied_vol, "delta")}");
                Console.WriteLine($"The option gamma is {europeanOption.sensitivity(_share_price, rf, div_yield, implied_vol, "gamma")}");
                Console.WriteLine($"The option vega is {europeanOption.sensitivity(_share_price, rf, div_yield, implied_vol, "vega")}");
                Console.WriteLine($"The implied volatility is {imp_vol}");
        ...
        private static async Task<List<MarketData>> LoadExcelFile(FileInfo path, string shareName, string date, double maturity)
        {
...
//In the case the number of days to maturity is between two values, call the interpolation function here. Here we do a basic calculation and take the average.
...
////Get implied volatility values - code below/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            double _vol = getPercentage(ws_vol, maturity, date_row_vol, start_col_vol);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////Get the dividend yield values - code below///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            double _div = getPercentage(ws_div, maturity, date_row_div, start_col_div);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
